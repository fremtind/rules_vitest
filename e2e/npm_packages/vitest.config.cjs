...
const ESM_NPM_DEPS = ["@e2e/lib", "@e2e/wrapper-lib"];
...
module.exports = {
  ...
  // See pnpm notes: https://vitestjs.io/docs/configuration#transformignorepatterns-arraystring
  ...
  setupFiles: [path.join(process.cwd(), "tools/vitest-env.js")],
};
